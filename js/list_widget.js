...
export class ListWidget {
  constructor(data, id) {
    ...
    // this._dataElementZone.addEventListener("onmousedown", this._onMouseDown);
  ...
  _makeMovableElement(text) {
    ...
    dataElement.addEventListener("dragstart", handleStartDragging, false);
    dataElement.addEventListener("dragover", handleDragOver, false);
    dataElement.addEventListener("drop", handleDrop, false);
